...
int main() {
    // window lives through out this main scope allowing unique_ptr to clean up
...

    {
        ...
        quadList.push_back(std::make_unique<Quad2D>(
            quadOneCenter, static_cast<float>(windowProperties.Width / 15.0f),
            static_cast<float>(windowProperties.Height / 10.0f),
            std::string("./res/textures/NGGYU.png")));

        quadList.push_back(std::make_unique<Quad2D>(
            quadTwoCenter, static_cast<float>(windowProperties.Width / 15.0f),
            static_cast<float>(windowProperties.Height / 25.0f),
            std::string("./res/textures/greyTile.png")));

        quadList.push_back(std::make_unique<Quad2D>(
            quadThreeCenter, static_cast<float>(windowProperties.Width / 15.0f),
            static_cast<float>(windowProperties.Height / 15.0f),
