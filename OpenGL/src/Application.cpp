...
// int main() {
//     // window lives through out this main scope allowing unique_ptr to clean
//     up
//     // and avoid glfwTerminating twice
...
//         quadList.push_back(std::make_unique<Quad2D>(
//             quadOneCenter, static_cast<float>(windowProperties.Width
//             / 15.0f), static_cast<float>(windowProperties.Height / 10.0f),
//             std::string("./res/textures/NGGYU.png")));

//         quadList.push_back(std::make_unique<Quad2D>(
//             quadTwoCenter, static_cast<float>(windowProperties.Width
//             / 15.0f), static_cast<float>(windowProperties.Height / 25.0f),
//             std::string("./res/textures/greyTile.png")));

//         quadList.push_back(std::make_unique<Quad2D>(
//             quadThreeCenter, static_cast<float>(windowProperties.Width
//             / 15.0f), static_cast<float>(windowProperties.Height / 15.0f),
//             std::string("./res/textures/awwsomeFace.png")));
...
//         layout1.Push(2, DataType::FLOAT);  // pos
//         layout1.Push(2, DataType::FLOAT);  // tex
//         VA.AddBuffer(VBO, layout1);

//         Shader defaultShader("./res/shader/vertex/default.vertexShader",
//                              "./res/shader/fragment/default.fragmentShader");
//         Shader basicShader("./res/shader/vertex/basicShader.vertexShader",
//                            "./res/shader/fragment/basicShader.fragmentShader");
...
//         proj = glm::ortho(0.0f, (float)windowProperties.Width, 0.0f,
...
//                     glm::mat4(1.0f), glm::vec3(xOffset, yOffset, 0.0f));
